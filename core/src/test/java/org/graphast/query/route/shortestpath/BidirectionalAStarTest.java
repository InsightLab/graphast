...
public class BidirectionalAStarTest {
	...
	public void monacoTest() {
		...
		// regularDijkstra.shortestPath(graph.getNode(source),
		// graph.getNode(target));
		//
		// regularDijkstraSW.stop();
		//
		// assertEquals(expectedDistance,
		// regularDijkstraFinalPath.getTotalDistance());
		//
		// logger.info("[REGULAR DIJKSTRA] Execution Time: {}ms",
		// regularDijkstraSW.getNanos());
		//
		// logger.info("[REGULAR DIJKSTRA] Shortest Path");
		// logger.info("\t{}", regularDijkstraFinalPath.getInstructions());
		//
		// System.out.println("[REGULAR DIJKSTRA] Number of settle nodes: " +
		// regularDijkstra.getNumberOfTotalSettleNodes());

		for (int i = 0; i < graph.getNumberOfNodes(); i++) {
			System.out.println("Nó: " + i + ", Level: " + graph.getNode(i).getLevel());
		}
		...
		Path bidirectionalDijkstraFinalPath = bidirectionalDijkstra.execute(graph.getNode(554), graph.getNode(761));
		bidirectionalDijkstraSW.stop();

		// logger.info("[BIDIRECTIONAL DIJKSTRA] Execution Time: {}ms",
		// bidirectionalDijkstraSW.getNanos());
		//
		// logger.info("[BIDIRECTIONAL DIJKSTRA] Shortest Path");
		// logger.info("\t{}",
		// bidirectionalDijkstraFinalPath.getInstructions());
		//
		// assertEquals(expectedDistance,
		...
		//
		// //BIDIRECTIONAL A*
		// BidirectionalAStarCH bidirectionalAStar = new
		// BidirectionalAStarCH(graph);
		//
		// StopWatch bidirectionalAStarSW = new StopWatch();
		//
		// bidirectionalAStarSW.start();
		// Path bidirectionalAStarFinalPath =
		// bidirectionalAStar.execute(graph.getNode(source),
		// graph.getNode(target));
		// bidirectionalAStarSW.stop();
		//
		// logger.info("[BIDIRECTIONAL A*] Execution Time: {}ms",
		// bidirectionalAStarSW.getNanos());
		//
		// logger.info("[BIDIRECTIONAL A*] Shortest Path");
		// logger.info("\t{}", bidirectionalAStarFinalPath.getInstructions());
		//
		// System.out.println("[BIDIRECTIONAL A*] Number of settle nodes: " +
		// (bidirectionalAStar.getNumberOfForwardSettleNodes() +
		// bidirectionalAStar.getNumberOfBackwardSettleNodes()));
		//
		// assertEquals(expectedDistance,
		// bidirectionalAStarFinalPath.getTotalDistance());
	...
	// BidirectionalDijkstraCH(graph);
	//
	// StopWatch bidirectionalDijkstraSW = new StopWatch();
	//
	// bidirectionalDijkstraSW.start();
	// Path bidirectionalDijkstraFinalPath =
	// bidirectionalDijkstra.execute(graph.getNode(source),
	// graph.getNode(target));
	// bidirectionalDijkstraSW.stop();
	//
	// logger.info("[BIDIRECTIONAL DIJKSTRA] Execution Time: {}ms",
	...
	// bidirectionalAStarSW.start();
	// Path bidirectionalAStarFinalPath =
	// bidirectionalAStar.execute(graph.getNode(source), graph.getNode(target));
	// bidirectionalAStarSW.stop();
	//
	// logger.info("[BIDIRECTIONAL A*] Execution Time: {}ms",
	// bidirectionalAStarSW.getNanos());
	...
	//
	// // Machida
	// Long source = graphTokyoBigger.getNodeId(35.709955782665816,
	// 139.61964822455454);
	// // Tokorozawa
	// Long target = graphTokyoBigger.getNodeId(35.778598169504065,
	// 139.62021838024748);
	//
	// // REGULAR DIJKSTRA
	// Dijkstra regularDijkstra = new DijkstraConstantWeight(graph);
	...
	//
	// System.out
	// .println("[REGULAR DIJKSTRA] Number of settle nodes: " +
	// regularDijkstra.getNumberOfTotalSettleNodes());
	//
	// // BIDIRECTIONAL DIJKSTRA
	// BidirectionalDijkstraCH bidirectionalDijkstra = new
	...
	//
	// System.out.println(
	// "[BIDIRECTIONAL A*] Number of settle nodes: " +
	// (bidirectionalAStar.getNumberOfForwardSettleNodes()
	// + bidirectionalAStar.getNumberOfBackwardSettleNodes()));
	//
	// assertEquals(expectedDistance,
