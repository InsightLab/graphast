...
public class BidirectionalDijkstraTest {
	...
	public static void setup() {
		...
		graphHopperExample4 = new GraphGenerator().generateGraphHopperExample4Test();
...
//
//				assertEquals(dijkstraPath.getTotalCost(), finalPath.getTotalCost(), 0);
//
////			}
////		}
//	}
	...
	// System.out
	// .println("Different results between source " + source + " and destination
	// " + destination);
	// System.out.println("\tSource: " + testGraph.getNode(source).getLatitude()
	// + ","
	// + testGraph.getNode(source).getLongitude());
	// System.out.println("\tDestination: " +
	// testGraph.getNode(destination).getLatitude() + ","
	// + testGraph.getNode(destination).getLongitude());
	// System.out.println("Graphast distance: " +
	// dijkstraPath.getTotalDistance()
	...
	// Dijkstra dijkstra = new DijkstraConstantWeight(testGraph);
	// Path dijkstraPath = dijkstra.shortestPath(testGraph.getNode(source),
	// testGraph.getNode(target));
	//
	// for (Long id : dijkstraPath.getEdges()) {
	// System.out.println(
	// "FROM: " + testGraph.getEdge(id).getFromNode() + ", TO: " +
	// testGraph.getEdge(id).getToNode());
	// }
	//
	// BidirectionalDijkstraCH bidirectionalDijkstra = new
	// BidirectionalDijkstraCH(testGraph);
	...
	// testGraph.getNode(target));
	//
	// if ((int) finalPath.getTotalCost() != (int)
	// dijkstraPath.getTotalDistance()) {
	// System.out.println("Different results between source " + source + " and
	// destination " + target);
	// System.out.println("\tSource: " + testGraph.getNode(source).getLatitude()
	// + ","
	// + testGraph.getNode(source).getLongitude());
	// System.out.println("\tDestination: " +
	// testGraph.getNode(target).getLatitude() + ","
	// + testGraph.getNode(target).getLongitude());
	// System.out.println("Regular Dijkstra distance: " +
	// dijkstraPath.getTotalDistance()
	...
	// BidirectionalDijkstraCH(testGraph);
	//// Path finalPath =
	// bidirectionalDijkstra.execute(testGraph.getNode(source),
	// testGraph.getNode(destination));
	//
	...
	// + testGraph.getNode(destination).getLongitude());
	// System.out.println("Graphast distance: " +
	// dijkstraPath.getTotalDistance() + ", Graphhopper distance: "
	// + distanceGraphhopper);
	// }
	//
	// // assertEquals(dijkstraPath.getTotalDistance(),
